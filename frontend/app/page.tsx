...
const Landing = () => {
  ...
  const timeline = [
  { step: "01", title: "Create Project", desc: "Define your workspace, domain, and processing instructions" },
  { step: "02", title: "Upload Documents", desc: "Drag-and-drop files — PDF, Word, Excel, images, and more" },
  { step: "03", title: "Automatic Ingestion", desc: "Text extraction, OCR, chunking, and embeddings run in the background" },
  { step: "04", title: "Query & Discover", desc: "Chat with your documents and get cited, grounded answers" },
 ];
            ...
            >
              ...
              >
                <Link href="/projects/new">
                  <Button
                    size="lg"
                    className="gap-2 rounded-xl px-6 shadow-lg hover:shadow-xl transition-all duration-300"
                  >
            ...
            <section id="features" className="py-20">
              ...
              >
                ...
                <p className="text-muted-foreground max-w-lg mx-auto">
                  Everything you need to extract, understand, and query complex
                  multimodal documents at scale.
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {features.map((f, i) => (
                  ...
                  >
                    <Card className="bg-card/50 border-border/50 hover:border-border transition-all h-full w-full max-w-sm">
            ...
            <section className="py-20">
              ...
              <div className="space-y-8 max-w-3xl mx-auto">
                {timeline.map((item, i) => (
                  ...
                  >
                    <div className="shrink-0 w-12 h-12 rounded-xl bg-muted flex items-center justify-center font-mono font-bold text-lg text-muted-foreground">
                      {item.step}
                    </div>
                    <div className="border-l border-border pl-6 pb-6">
              ...
              {loading ? (
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                    Create your first project to start uploading and processing
                    documents
                  </p>
                  <Link href="/projects/new">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-4 text-xs text-muted-foreground">
                                  <span className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-secondary/50">
                                    ...
                                    {p.totalDocuments} doc
                                    {p.totalDocuments !== 1 ? "s" : ""}
                                  </span>
                                  <span className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-secondary/50">
